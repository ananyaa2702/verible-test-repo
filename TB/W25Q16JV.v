...
`ifdef CADENCE_GLS
`define MEM_FILENAME "../flash_memory_files/flash_init_memory.memh"
`define SECSI_FILENAME "../flash_memory_files/SECSI.TXT"
`define SFDP_FILENAME "../flash_memory_files/SFDP.TXT"
`define SREG_FILENAME "../flash_memory_files/SREG.TXT"
`else
`define MEM_FILENAME "flash_init_memory.memh"
