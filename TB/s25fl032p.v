//////////////////////////////////////////////////////////////////////////////
//  File name : s25fl032p.v
//////////////////////////////////////////////////////////////////////////////
//  Copyright (C) 2011 Spansion, LLC.
//
...
//    V1.2     D.Stanojkovic     08 Mar 05   MPM mode corrected
//    V1.3     D.Stanojkovic     08 Mar 20   MPM mode removed
//    V1.4     J.Stoickov        08 Aug 07   WEL bit corrected
//    V1.5     J.Stoickov        08 Sep 16   Latest datasheet aligned
//    V1.6     J.Stoickov        08 Dec 10   Latest datasheet aligned
//                                            (S25FL129 064 032P)
//                                          Program Error bit will not be
//                                          set after programming in
//                                          protect memory region
//    V1.7     V.Mancev          10 Sep 29   Implementation of internal pull-up
//                                           for HOLDNeg and WPNeg pins
//    V1.8     V.Mancev          11 Dec 15   Latest datasheet aligned
//                                                (S25FL032P_00_05)
//////////////////////////////////////////////////////////////////////////////
//  PART DESCRIPTION:
//
...
//  Part:       S25FL032P
//
//  Description: 32 Megabit Serial Flash Memory with 104 MHz SPI Bus Interface
//  Comments :
...
// Uncomment for ASIC and CADENCE GLS
...
//  internal delays
    ...
    `ifdef CADENCE_GLS
    parameter mem_file_name     = "../flash_memory_files/flash_init_memory.memh";//"s25fl032p.mem";
    `else
    parameter mem_file_name     = "flash_init_memory.memh";//"s25fl032p.mem";
    `endif

    parameter otp_file_name     = "none";//"s25fl032p_secsi.mem";

    parameter TimingModel   = "DefaultTimingModel";

    parameter PartID        = "s25fl032p";
    parameter MaxData       = 255;
    parameter SecSize       = 16'hFFFF;
    parameter SecSize_4     = 4095;
    parameter SecSize_8     = 8191;
    parameter SecNum        = 63;
    parameter PageNum       = 16'h3FFF;
 ...
 specify
     ...
     specparam           tperiod_SCK_rdid            =1; // fSCK = 50MHz
        ...
        `ifdef SPEEDSIM
            ...
            specparam   tdevice_BE                     = 64e9; //64 ms;
                    //Write Status Register Operation
            specparam   tdevice_WR                     = 5e8; // 0.5 ms;
            ...
            specparam   tdevice_PE                     = 800e6; //800 us;
                    //VCC (min) to CS# Low
            specparam   tdevice_PU                     = 100; //300 us;
        `else
            // Page Program Operation
            ...
            specparam   tdevice_SE                     = 2e12; //2 s;
                    //Bulk Erase Operation
            specparam   tdevice_BE                     = 64e12; //64 sec;
                    //Write Status Register Operation
            specparam   tdevice_WR                     = 50e9; // 50 ms;
                    //Software Protect Mode
            specparam   tdevice_DP                     = 10000000; // 10 us;
                    //Release from Software Protect Mode
            specparam   tdevice_RES                    = 30000000; // 30 us;
...
//Bus cycle states
 ...
 reg deq_holdin;
    ...
    integer i;
        ...
        begin
           // Memory Preload
           // s25fl032p.mem, memory preload file
        ...
        begin
            case (Status_reg[4:2])
                ...
                begin
                    if (~Sec_conf_reg[5])
                    begin
                        Sec_Prot[SecNum : (SecNum+1)*63/64] = 1'b1;
