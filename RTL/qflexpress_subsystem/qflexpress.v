...
//////////////////////////////////////////////////////////////////////////////////
// Engineer: Dan Gisselquist, Ph.D.
// Update Date: 29.03.2026
// Module Name: qflexpress
// Project Name: Silicon SoC KNN
// Description:
// Open-source Wishbone-controlled QSPI flash controller from Gisselquist
// Technology, used for fast read/XIP access and flash startup/config sequencing.
//
//////////////////////////////////////////////////////////////////////////////////
...
/*		integer k;
		...
		always @(posedge i_clk)
		if( !i_reset)              // CHANGED
			m_this_word <= -1; // CHANGED
		else if (new_word)         // CHANGED
...
`endif
	...
	begin : OPT_PIPE_BLOCK
		...
		always @(posedge i_clk)
		if (!i_reset)               // CHANGED
			r_pipe_req <= 1'b0; // CHANGED
		else if ((clk_ctr == 1)&&(ckstb))
			r_pipe_req <= 1'b0;
		else
...
`endif // FORMAL
	...
	if (!i_reset)               // CHANGED
	begin                       // CHANGED
		cfg_speed <= 1'b0;  // CHANGED
		cfg_dir   <= 1'b0;  // CHANGED
	end                         // CHANGED
	else if (!OPT_CFG)
	begin
		cfg_speed <= 1'b0;
